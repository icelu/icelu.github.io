...
SVs often alter large genomic regions and play an important role in cancer progression. However, the complete landscape of SVs in cancer genomes has been understudied due to technical limitations and gradually gets improved with the new sequencing techniques such as long-read sequencing. Due to the extreme variety of SVs, graph-based genome representation provides a natural way to analyze SVs, but the utilities of these graphs have not been fully exploited.
